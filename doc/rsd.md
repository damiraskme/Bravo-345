...
1. User Authentication and Roles:
   ...
   >3. Less than a week of implementation time.
...
2. Student Profile:
   ...
   >1. 80 to 100 NLOCs.
   >2. One or two team member(s).
   >3. Less than three days of implementation time.
   >4. Have complience with WCAG.
...
3. Academic Planning:
   ...
   >1. 500 to 800 KNLOCs.
   >2. Two or three team members.
   >3. Approximetaly week of implementation time.
   >4. Have complience with WCAG.
...
8. Notifications and Alerts:
   ...
   >1. 600 to 700 NLOCs.
   >2. Three team member(s).
   >3. Less than two weeks of implementation time.
   >4. Have complience with WCAG.

9. Document Management:
   - Students shall be able to upload and store academic documents such as transcripts and letters of recommendation.
   >1. 500 to 600 NLOCs.
   >2. Two or three team member(s).
   >3. 2 to 3 weeks of implementation time.
   >4. Have complience with WCAG.
...
10. Reporting and Analytics:
   ...
   >1. 1,000 to 1,200 NLOCs.
   >2. Three team members.
   >3. 3 to 4 weeks of implementation time.
   >4. Have complience with WCAG.
...
13. User-Friendly Interface:
   ...
   >1. Over 5,000 NLOCs.
   >2. Two to three team members.
   >3. Over 6 weeks of implementation time.
   >4. Have complience with WCAG.
...
19. Accessibility:
   ...
   >1. Over 1,000 NLOCs.
   >2. Two or three team members.
   >3. Over 2 weeks of implementation time.
   >4. Have complience with WCAG.

---
| Must haves | Should haves | Could haves | Won’t haves | 
| :--- | :----: | :----: | ---: |
| User Authentication and Roles | Student Profile | Course Recommendations| |
| Course Registration | Academic Planning | User-Friendly Interface | |
| Degree Requirements | Academic Advisor Interaction | | |
| Notifications and Alerts | Administrative Features | | |
| Security and Data Privacy | Reporting and Analytics | | |
| Help and Support | Document Management | | |
| Integration | Scalability and Performance | | |
| Testing and Quality Assurance | Accessibility | | |
| Documentation | | | |
